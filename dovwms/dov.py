...
class DOVClient(WMSClient):
    ...
    def fetch_profile(self, location: Point, fetch_elevation: bool = False, crs: str = "EPSG:31370") -> Optional[Dict[str, Any]]:
        ...
        try:
            ...
            result = self.parse_feature_info(
                response.read(), 
...
def get_profile_from_dov(
    ...
    profile_name: Optional[str] = None) -> Optional[Dict[str, Any]]:
