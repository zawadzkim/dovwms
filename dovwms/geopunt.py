...
class GeopuntClient(WMSClient):
    ...
    def fetch_elevation(self, 
                        location: Point, 
                        crs: str = "EPSG:31370", 
                        layer_name: str = "DHMVII_DTM_1m") -> Optional[Dict[str, Any]]:
...
def get_elevation(location: Point, crs: str = "EPSG:31370", layer_name: str = "DHMVII_DTM_1m") -> Optional[Dict[str, Any]]:
